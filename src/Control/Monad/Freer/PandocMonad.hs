...
--instance FR.Member Pandoc effs => MonadError P.PandocError (FR.Eff effs) where
--  throwError = 
...
type PandocEffects effs = (FR.Members '[Pandoc, Log.Logger] effs, MonadError P.PandocError (FR.Eff effs))
