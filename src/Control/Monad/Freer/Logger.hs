...
-- interpret in State and MonadLog
runLoggerML :: (MonadLog LogEntry (FR.Eff effs))
  => forall effs a. [LogSeverity] -> FR.Eff (Logger ': effs) -> FR.Eff effs () a
runLoggerML ls = FR.eval
